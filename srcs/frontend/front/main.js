...
document.addEventListener("DOMContentLoaded", () => {
            ...
            <div class="main">
                ...
                <div class="middle">
                    ...
                    <div>
                        ...
                        <button class="f_img_l2" id="friends-btn" type="button">Friends</button>
                        <button class="f_img_l3" id="pending-btn" type="button">Pending Requests</button> <!-- Added -->
                        <img class="f_img_last" src="dashboard img/FREINDLIST_041332.png">
                    </div>
                </div>
            </div>
    ...
    /////////////////get infos by user id up function
...
async function fetchAndDisplayFriends(friendsButton) {
    try {
        ...
        if (data.data && Array.isArray(data.data)) {
            friendList = data.data; // Use directly since UserSerializer returns flat data
        } else {
